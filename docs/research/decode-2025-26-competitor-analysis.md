...
| 24089 Iron Lions | `IronLionsFTC/FTC24089-DECODE` | Java / MIT-variant | FTCLib-inspired task/state-machine architecture, Pedro package, Limelight3A, projectile model, turret/shooter/feed subsystems, offline projectile simulator constants | See the detailed Iron Lions section for the required verbatim warning about `proj_motion.py` line 39 |
